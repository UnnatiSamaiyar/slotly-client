        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
          ...
          <header className="mb-20">
            ...
            <p className="mt-6 text-xl text-slate-600 max-w-3xl leading-relaxed">
              Slotly (“we”, “our”, “us”) respects your privacy and is committed
              to protecting your personal information. This Privacy Policy
              explains how we collect, use, store, and protect data when you use
            ...
            <div className="bg-white border border-slate-200 rounded-3xl shadow-sm p-12">
              <Section id="collect" title="1. Information We Collect">
                ...
                <p>
                  ...
                  we may receive your name, email address, and profile image (if
              ...
              <Section id="sharing" title="4. Data Sharing">
                We may share limited data only with trusted third parties such
                as hosting providers, analytics services, notification services,
                and payment processors (if applicable). All third parties are
