...
export default function Topbar({
  ...
  return (
    <header
      data-tour="topbar-area"
      className="w-full border-b border-slate-200/70 bg-white"
    >
      <div className="flex h-14 min-w-0 items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">

        <div className="min-w-0 flex-1">
          <h1 className="truncate text-[15px] font-semibold leading-5 tracking-[-0.01em] text-slate-900 sm:text-[17px]">
            {topbarTitle}
          </h1>
        </div>
...
//               onClick={handleMarkAllNotificationsRead}
//               disabled={notificationUnreadCount <= 0}
//               className={`inline-flex h-8 items-center gap-1.5 whitespace-nowrap rounded-xl border px-2.5 text-[12px] font-semibold shadow-sm transition active:scale-[0.97] sm:px-3 ${notificationUnreadCount > 0
//                   ? "border-indigo-200 bg-indigo-50 text-indigo-700 hover:border-indigo-300 hover:bg-indigo-100"
//                   : "cursor-not-allowed border-slate-200 bg-white text-slate-400"
//                 }`}
//             >
