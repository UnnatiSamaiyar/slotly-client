  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-0 sm:px-4">
      ...
      <motion.div
        ...
        className="relative z-10 flex h-[92vh] w-full flex-col overflow-hidden rounded-t-3xl bg-white shadow-2xl sm:h-auto sm:max-w-md sm:rounded-2xl"
      >
        <form onSubmit={submit} className="flex h-full flex-col">
          <div className="flex items-start gap-3 border-b border-slate-100 px-4 py-4 sm:px-5 sm:py-5">
          ...
          <div className="flex-1 space-y-3 overflow-y-auto px-4 py-4 sm:px-5">
            <div>
              ...
              <input value={title} onChange={(e) => setTitle(e.target.value)} className="mt-1 w-full rounded-xl border px-3 py-2.5" />
            </div>
            ...
            <div>
              ...
              <div className="mt-1 flex flex-col items-stretch gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  ...
                  className="w-full rounded-xl border px-3 py-2 text-sm hover:bg-slate-50 sm:w-auto"
                >
                  Edit availability
                </button>
              </div>
          ...
          <div className="border-t border-slate-100 px-4 py-4 sm:px-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <button
                ...
                onClick={doDelete}
                disabled={deleting}
                className="flex w-full items-center justify-center gap-2 rounded-xl px-3 py-2 text-sm text-red-600 hover:bg-red-50 disabled:opacity-60 sm:w-auto sm:justify-start"
              >
              ...
              <div className="flex flex-col-reverse gap-3 sm:flex-row sm:items-center">
                <button
                  type="button"
                  onClick={onClose}
                  className="w-full rounded-xl px-3 py-2 hover:bg-slate-50 sm:w-auto"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={saving}
                  className="w-full rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 px-4 py-2 text-white font-semibold disabled:opacity-60 sm:w-auto"
                >
