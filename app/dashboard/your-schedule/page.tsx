...
export default function YourSchedulePage() {
  ...
  return (
    <div className="max-w-6xl pb-24 sm:pb-10">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="min-w-0">
          <h2 className="text-2xl font-semibold text-slate-900">Your Availability</h2>
        ...
        <button
          ...
          className={cx(
            "hidden sm:inline-flex items-center justify-center h-11 px-6 rounded-xl text-sm font-semibold transition shadow-sm",
        ...
        <div className="lg:col-span-4">
            ...
            <div className="mt-4 space-y-4">
              <div className="space-y-2">
                ...
                <div className="text-xs text-slate-500">
                  Host timezone (used for availability rules + booking links)
                </div>
          ...
          <div className="mt-6 bg-indigo-50 border border-indigo-100 rounded-2xl p-4">
            ...
            <div className="mt-1 text-xs text-indigo-800 leading-relaxed">
              Invitees can pick their timezone for display, but availability is always
              evaluated in your host timezone. Buffers, min notice, and max days ahead are
        ...
        <div className="lg:col-span-8">
          {activeTab === "weekly" && (
            <div className="bg-white rounded-2xl border border-slate-200 shadow-[0_1px_0_rgba(15,23,42,0.04)] p-5">
              ...
              <div className="mt-1 text-xs text-slate-500">
                Set one time window for each day. Use advanced settings if you need multiple
                time windows in a single day.
              </div>
...
//           <div className="w-full sm:w-auto">
//             <div className="mt-3 sm:mt-0 flex gap-2 overflow-x-auto pb-1">
//               <TabButton id="weekly" label="Weekly hours" activeTab={activeTab} setActiveTab={setActiveTab} />
//               <TabButton
//                 id="overrides"
//                 label="Overrides"
//                 disabled={uiDisabledByJson}
...
//         {rawJsonMode ? (
//           <div className="mt-3 text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-xl p-3">
//             When enabled, standard date-based editors will be temporarily disabled to keep your availability rules consistent.
//           </div>
//         ) : null}
//       </div>
...
//               <div className="text-sm font-semibold text-slate-900">Weekly hours</div>
//               <div className="mt-1 text-xs text-slate-500">
// Set one time window for each day. Use advanced settings if you need multiple time windows in a single day.
//               </div>
...
//               {rawJsonMode ? (
//                 <div className="mt-4 text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-xl p-3">
//                   Date overrides are temporarily unavailable while advanced settings are active. Turn off advanced settings to use this section.
//                 </div>
//               ) : (
//                 <div className="mt-4 space-y-4">
//                   <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 items-end">
...
//               {rawJsonMode ? (
//                 <div className="mt-4 text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-xl p-3">
//                   Time blocks UI is disabled while JSON mode is enabled. Turn off JSON mode to
//                   use this editor.
//                 </div>
//               ) : (
//                 <div className="mt-4 space-y-4">
...
//               {rawJsonMode ? (
//                 <div className="mt-4 text-xs text-amber-800 bg-amber-50 border border-amber-200 rounded-xl p-3">
//                   Date range UI is disabled while JSON mode is enabled. Turn off JSON mode to
//                   use this editor.
//                 </div>
//               ) : (
//                 <div className="mt-4 space-y-4">
