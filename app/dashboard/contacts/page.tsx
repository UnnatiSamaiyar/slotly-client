...
export default function ContactsPage() {
  ...
  return (
    <div className="max-w-6xl space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-[0_1px_0_rgba(15,23,42,0.04)] p-4">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="relative w-full lg:max-w-[520px]">
            <Search className="w-4 h-4 text-slate-400 absolute left-3 top-1/2 -translate-y-1/2" />
            <input
        ...
        {loading ? (
          <div className="mt-3 text-sm text-slate-500">Loading contacts…</div>
        ) : null}
        {error ? (
