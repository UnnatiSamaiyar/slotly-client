export default function PublicBookingSlots({
  ...
  return (
    <div>
      ...
      <div className="max-h-[50vh] sm:max-h-80 overflow-y-auto pr-1 sm:pr-2 space-y-4">
              ...
              {daySlots.map((slot: any) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      "px-3 py-2 sm:px-3 sm:py-2 rounded-lg border text-xs sm:text-sm transition-all",
