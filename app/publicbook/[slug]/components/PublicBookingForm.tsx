...
//           <div className="p-4 max-h-[66vh] ">{children}</div>
...
//               <div className="rounded-md border bg-gray-50 px-3 py-2 text-sm text-gray-700 leading-snug">
//                 {locationPreview}
//               </div>
...
export default function PublicBookingForm({
  ...
  async function submit() {
    ...
    if (meetingMode === "in_person" && normalizedLocation.length < 10) {
      setLocationModalOpen(true);
      return setMessage(
        "Please provide a complete meeting location (full address)."
      );
    }
