  ...
  const pillars = [
    {
      ...
      title: "Secure OAuth",
      // ✏️ CHANGED
      desc: "Connect your calendar with scoped OAuth permissions — Slotly never accesses more than it needs.",
    },
    {
      icon: Lock,
      title: "End-to-End Encrypted",
      // ✏️ CHANGED
      desc: "All scheduling data is encrypted in transit and at rest — your information stays protected at every step.",
    },
    {
      icon: BadgeCheck,
      title: "GDPR Compliant",
      // ✏️ CHANGED
      desc: "Built with European privacy standards in mind — full data portability, deletion rights, and transparent controls.",
    },
    {
      icon: Fingerprint,
      title: "Privacy by Default",
      // ✏️ CHANGED
      desc: "Attendees only see your available slots — never your event titles, notes, or any private calendar data.",
    },
  ];

  const metrics = [
    // ✏️ CHANGED
    { label: "Calendar access", value: "Scoped only" },
    { label: "Data in transit & at rest", value: "Encrypted" },
    { label: "Attendee data exposure", value: "Availability only" },
    { label: "Regulatory compliance", value: "GDPR-ready" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-8 lg:gap-10 items-start">
          ...
          >
            ...
            <h2 className="mt-5 text-3xl sm:text-4xl font-semibold tracking-tight text-gray-900">
              ...
              <span className="text-blue-600">Total peace of mind.</span>
            </h2>

            {/* ✏️ CHANGED */}
            <p className="mt-3 text-base sm:text-lg text-gray-600 leading-relaxed max-w-2xl">
              Slotly is built security-first — protecting every booking interaction
              without adding friction. Your data stays private, your calendar stays
              yours, and your attendees only ever see what you choose to share.
            </p>
          </motion.div>
          ...
          >
            {/* ✏️ CHANGED */}
            <div className="text-sm font-semibold text-gray-900">Security at a glance</div>

            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
              {metrics.map((m) => (
                <div key={m.label} className="rounded-2xl border border-gray-200 bg-white px-4 py-3">
                  <div className="text-xs text-gray-500">{m.label}</div>
                  <div className="mt-1 text-sm font-semibold text-gray-900">{m.value}</div>
                </div>
              ))}
            ...
            {/* ✏️ CHANGED */}
            <div className="mt-5 text-xs text-gray-500 leading-relaxed">
              Your calendar data never leaves our secure infrastructure. Attendees
              see availability — nothing more.
            </div>
          </motion.div>
        </div>
          ...
          <div className="relative bg-[#0b0c0f]">
            ...
            <div className="relative px-4 sm:px-6 lg:px-10 py-8 sm:py-10">
              <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4">
                <div>
                  {/* ✏️ CHANGED */}
                  <div className="text-white/70 text-sm">Trusted by professionals worldwide</div>
                  <div className="mt-1 text-white text-2xl sm:text-3xl font-semibold tracking-tight">
                    {/* ✏️ CHANGED */}
                    Your security handled. Your focus protected.
                  </div>
                </div>
                ...
                {pillars.map((p, i) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="text-white font-semibold">{p.title}</div>
                        <div className="mt-1 text-white/70 text-sm leading-relaxed">{p.desc}</div>
                      </div>
                    </div>
                  </motion.div>
                ))}
              ...
              <div className="mt-7 sm:mt-8 rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="text-white/80 text-sm">
                  Your calendar details remain private. Attendees only see when you're free.
                </div>
                <div className="text-white text-sm font-semibold">
                  Secure from the first booking.
                </div>
              </div>
            </div>
          </div>
...
export function FAQSection() {
  const faqs = useMemo(
    () => [
      {
        // ✏️ CHANGED
        q: "Is Slotly free to use?",
        a: "Yes — Slotly offers a free plan with everything you need to get started. Upgrade to a paid plan when you need advanced automation, team features, custom domains, or higher booking volumes.",
      },
      {
        q: "Does Slotly support teams?",
        // ✏️ CHANGED
        a: "Absolutely. Slotly is built for teams of all sizes. Create round-robin booking flows, shared availability pages, and manage multiple team members from a single workspace.",
      },
      {
        // ✏️ CHANGED
        q: "How does Slotly handle time zones?",
        a: "Slotly automatically detects each attendee's local time zone and displays your availability accordingly — no manual conversions, no miscommunications, no missed meetings.",
      },
      {
        // ✏️ CHANGED
        q: "Which calendars does Slotly sync with?",
        a: "Slotly syncs in real time with Google Calendar, Outlook, and iCal. Changes on either side are reflected instantly — keeping your availability always accurate and conflict-free.",
      },
      {
        q: "What do attendees see when they book?",
        // ✏️ CHANGED
        a: "Attendees see only your available time slots and the meeting details you've chosen to share. Private event titles, notes, and calendar data are never exposed.",
      },
    ],
    []
  );
    ...
    <section id="faq" className="relative w-full overflow-hidden bg-white">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20">
        ...
        >
          ...
          {/* ✏️ CHANGED */}
          <p className="mt-3 text-base sm:text-lg text-gray-600 leading-relaxed">
            Common questions answered — so you can get started with confidence.
          </p>
        </motion.div>
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-8 lg:gap-10 items-start">
          ...
          <div className="rounded-3xl border border-gray-200 bg-white/80 backdrop-blur p-5 sm:p-6 shadow-[0_24px_70px_-55px_rgba(15,23,42,0.22)]">
            {/* ✏️ CHANGED */}
            <div className="text-base font-semibold text-gray-900">Why teams choose Slotly</div>

            <div className="mt-4 space-y-3">
              {/* ✏️ CHANGED all rail items */}
              <RailItem icon={CalendarDays} title="One booking link" desc="Share a single link — let attendees pick the perfect time." />
              <RailItem icon={Globe2} title="Global time zones" desc="Every attendee sees slots in their own local time." />
              <RailItem icon={Users} title="Team scheduling" desc="Round-robin, collective pages, and multi-host support." />
              <RailItem icon={RefreshCw} title="Real-time sync" desc="Two-way calendar sync — always accurate, never stale." />
              <RailItem icon={Clock} title="Smart automation" desc="Confirmations, reminders, and follow-ups run themselves." />
            </div>
...
function RailItem({ icon: Icon, title, desc }: { icon: any; title: string; desc: string }) {
  return (
    <div className="flex items-start gap-3 rounded-2xl border border-gray-200 bg-white px-4 py-3">
      <div className="shrink-0">
        <div className="h-10 w-10 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 text-white flex items-center justify-center">
